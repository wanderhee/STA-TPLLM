...
#     L = D - W
#
#     # shift变换将特征值对角矩阵转换到[-1,1] eigs:求特征值函数 这里求最大特征值
#     lambda_max = eigs(L, k=1, which='LR')[0].real
#
#     # 2倍拉普拉斯矩阵-单位阵，将[0,1]变为[0,2]再变为[-1,1]，以满足切比雪夫多项式中arccos的定义域要求
...
def predict_and_save_results(net, data_loader, data_target_tensor, global_step, metric_method,_mean, _std, params_path, type):
    '''
